...
{
    static public BindingExpression? GetBindingExpression(this FrameworkElement instance, DependencyProperty property)
    {
        return BindingOperations.GetBindingExpression(instance, property);
    }
